...
type IReportUseCase interface {
	...
	// GetByLesson(ctx context.Context, req payload.GetByLesson) (res bool, err error)
...
type IReportRepo interface {
	...
	GetByLesson(ctx context.Context, req payload.GetByLesson) (res models.Report, err error)
