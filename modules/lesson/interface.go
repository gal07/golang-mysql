...
type ILessonUseCase interface {
	InsertLesson(ctx context.Context, req models.Lesson) (res models.Lesson, err error)
	...
	SearchLesson(ctx context.Context, req payload.ReqSearch) (res []models.Lesson, err error)
...
type ILessonRepo interface {
	...
	Get(ctx context.Context, req payload.ReqGetAllLesson) (res payload.ResGetAllLesson, err error)
	GetDetail(ctx context.Context, req payload.ReqGetDetail) (res models.Lesson, err error)
